...
# words_clean <- words_noyear[words_noyear != "told", ]
# words_clean <- words_clean[words_clean != "abby", ]
# words_clean <- words_clean[words_clean != "abbys", ]
# words_clean <- words_clean[words_clean != "asked", ]

# 1985 - 2000
pre_2000 <- table(words$palabras[words$year < 2000])
pre_2000 <- data.frame(pre_2000)
pre_2000 <- pre_2000 [ order(pre_2000$Freq, decreasing = T), ]


post_2000 <- table(words$palabras[words$year > 1999])
